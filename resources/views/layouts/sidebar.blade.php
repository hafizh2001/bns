 ...
 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
         ...
         <a href="index.html" class="app-brand-link">
             <span class="app-brand-logo demo">
                 ...
                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                     style="fill: rgba(243, 9, 67, 1);transform: ;msFilter:;">
                     <path
             ...
             <span class="app-brand-text demo menu-text fw-bolder ms-3">Arsip Surat</span>
         </a>
     ...
     <ul class="menu-inner py-1">
         <li class="menu-header small text-uppercase">
             <span class="menu-header-text">MENU
             </span>
         </li>
         <!-- Dashboard -->
         <li class="menu-item ">
             <a href="/home" class="menu-link">
                 <i class="menu-icon tf-icons bx bx-book bx-tada"style='color:#f52121' ></i>
                 <div data-i18n="Analytics">Arsip</div>
             </a>
         </li>
         <li class="menu-item ">
             <a href="/about" class="menu-link">
             <i class="menu-icon tf-icons bx bx-id-card bx-tada"style='color:#06b3ef' ></i>
